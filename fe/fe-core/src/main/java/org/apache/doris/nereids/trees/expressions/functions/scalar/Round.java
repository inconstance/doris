...
public class Round extends ScalarFunction
    ...
    private Round(ScalarFunctionParams functionParams) {
    ...
    public Round withChildren(List<Expression> children) {
        ...
        return new Round(getFunctionParams(children));
    }
    ...
    public FunctionSignature computePrecision(FunctionSignature signature) {
        ...
        Integer scale = arity() == 1 ? 0 : getConstantScale();
        ...
        int resultPrecision = Math.max(1,
                inputType.getPrecision() - inputType.getScale() + resultScale + 1);
        return computedSignature.withReturnType(
